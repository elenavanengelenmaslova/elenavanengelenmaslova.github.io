...
Elena delivers talks in multiple formats to suit your event's needs:

- **Keynote** — High-level vision talks on Kotlin adoption, serverless architecture, and cloud-native engineering
- **Conference Session** — Deep-dive technical sessions with live coding on clean architecture, serverless patterns, and Kotlin best practices
- **Workshop** — Hands-on, half-day or full-day workshops where attendees build real systems with Kotlin on AWS or Azure
- **Live Coding Demo** — Interactive sessions where the audience follows along as Elena builds and deploys working serverless applications in real time
...
When you book Elena for your event, your audience gets:
...
- [**AWS Community Day NL (September 23, 2026)**](https://awscommunityday.nl/2026/){:target="_blank" rel="noopener"} — two sessions:
...
- [**J-Spring (June 4, 2026)**](https://devmio.nl/reader/player/j-spring-2026?Lesson=architecture-serverless-anywhere){:target="_blank" rel="noopener"} — Room 4, 11:35  
  *Clean Architecture for Serverless: Business Logic You Can Take Anywhere*
...
- [**ING Kotlin Summit (June 19, 2025)**](https://www.youtube.com/watch?app=desktop&v=0j5vhVn3nRs){:target="_blank" rel="noopener"}:  
  *7 ± 2 Kotlin Features That Can Work For or Against You*

- [**KotlinConf 2025 (May 21–23, 2025)**](https://youtu.be/6jZa4B-If-I){:target="_blank" rel="noopener"}:  
...
- [**AWS Community Day (2022)**](https://www.youtube.com/watch?v=GvAyaJZzQ5M){:target="_blank" rel="noopener"}:  
...
- [**InfoQ Podcast (August 6, 2025)**](https://www.infoq.com/podcasts/sovereign-clouds-hyperscalers-european-alternatives/){:target="_blank" rel="noopener"}:  
  *Sovereign Clouds, Hyperscalers and European Alternatives*

---

## Book Elena for Your Event

Looking for a speaker who brings energy, live coding, and practical content to your conference or meetup? Get in touch to discuss topics, formats, and availability.
